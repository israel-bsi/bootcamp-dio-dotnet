...
class Program
{
    static string VerificarForcaSenha(string senha)
    {
        ...
        temOitoCaracteres = senha.Length >= comprimentoMinimo;
        ...
        if (temOitoCaracteres && temLetraMinuscula && temLetraMaiuscula && temNumero && temCaractereEspecial)
